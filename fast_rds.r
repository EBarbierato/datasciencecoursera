...
saveRDS(bi_words, "./words_2_opt.rds")
saveRDS(tri_words, "./words_3_opt.rds")
saveRDS(quad_words,"./words_4_opt.rds")
saveRDS(quint_words,"./words_5_opt.rds")
saveRDS(sext_words,"./words_6_opt.rds")
#' 
#' -------------
#'  
#' ## Session info
